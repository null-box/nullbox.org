...
export const metadata = {
  ...
  description: "Nullbox Ltd's privacy policy regarding the collection and use of personal information.",
}
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-12">
            ...
            <Card>
              <CardContent className="pt-6">
                <p className="mb-4 text-xs">
                  Nullbox Ltd ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy
                  explains how we collect, use, disclose, and safeguard your information when you visit our website
                  nullbox.org (the "Site") or engage with our services.
                </p>
                <p className="text-xs">
          ...
          <section>
            ...
            <Card>
              ...
              <CardContent>
                <p className="mb-4 text-xs">
                  ...
                  limited to, when you visit our site, register on the site, fill out a form, and in connection with
                  other activities, services, features, or resources we make available on our Site. You may be asked
                  for, as appropriate:
                </p>
                ...
                <p className="text-xs">
                  You may, however, visit our Site anonymously. We will collect personal identification information from
                  you only if you voluntarily submit such information to us. You can always refuse to supply personal
                  identification information, except that it may prevent you from engaging in certain Site-related
                  activities.
                </p>
              </CardContent>
            </Card>
            ...
            <div className="mt-6">
              <Card>
                ...
                <CardContent>
                  <p className="mb-4 text-xs">
                    We may collect non-personal identification information about you whenever you interact with our
                  ...
                  <ul className="list-disc pl-6 space-y-2 text-xs">
                    ...
                    <li>
                      Technical information about your means of connection to our Site, such as operating system and
          ...
          <section>
            ...
            <Card>
              <CardContent className="pt-6">
                <p className="mb-4 text-xs">We may use the information we collect from you in the following ways:</p>
                <ul className="list-disc pl-6 space-y-2 text-xs">
                  <li>
                    To personalize your experience and to deliver content and product offerings relevant to your
                    interests
                  </li>
            ...
            <Card>
              <CardContent className="pt-6">
                <p className="mb-4 text-xs">
                  ...
                  to leave the Site, any information you provide to these third parties is not covered by this Privacy
                  ...
                  steps necessary to, in your discretion, protect the privacy of your information.
                </p>
                <p className="text-xs">
                  We are not responsible for the content or privacy and security practices and policies of any third
                  parties, including other sites, services or applications that may be linked to or from the Site.
                </p>
              </CardContent>
            </Card>
          </section>
          ...
          <section>
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-xs">
                  If you believe we might have any information from or about a child under 13, please contact us using
          ...
          <section>
            ...
            <Card>
              <CardContent className="pt-6">
                <p className="mb-4 text-xs">If you have any questions about this Privacy Policy, please contact us:</p>
                <ul className="list-disc pl-6 space-y-2 text-xs">
                  <li>
                    By email:{" "}
        ...
        <div className="text-center">
          <p className="text-xs text-muted-foreground">
            By using our website, you consent to our <span className="font-medium">Privacy Policy</span>.
          </p>
        </div>
      </div>
    </div>
