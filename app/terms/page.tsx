...
export const metadata = {
  ...
  description: "Nullbox Ltd's terms of service governing the use of our website and services.",
}
        ...
        <div className="space-y-12">
            ...
            <Card>
              <CardContent className="pt-6">
                <p className="mb-4 text-xs">
                  Welcome to Nullbox Ltd ("Company", "we", "our", "us"). These Terms of Service ("Terms", "Terms of
                  Service") govern your use of our website located at nullbox.org (the "Service") operated by Nullbox
                  Ltd.
                </p>
                <p className="mb-4 text-xs">
                ...
                <p className="text-xs">
                  If you do not agree with the Agreements, you must not use the Service. Please contact us if you have
            ...
            <Card>
              <CardContent className="pt-6">
                <p className="mb-4 text-xs">
                  ...
                  communications from us by following the unsubscribe link or by emailing contact@nullbox.org.
                </p>
              </CardContent>
            </Card>
          </section>
            ...
            <Card>
              <CardContent className="pt-6">
                <p className="mb-4 text-xs">
                  ...
                  may be asked to supply certain information relevant to your Purchase including your name, email, phone
                  number, credit card information, billing address, and shipping information.
                </p>
                <p className="mb-4 text-xs">
            ...
            <Card>
              <CardContent className="pt-6">
                <p className="mb-4 text-xs">
                  ...
                  any Promotions, please review the applicable rules as well as our Privacy Policy.
                </p>
                <p className="text-xs">
                  If the rules for a Promotion conflict with these Terms of Service, the Promotion rules will apply.
                </p>
              </CardContent>
            </Card>
          </section>
            ...
            <Card>
              <CardContent className="pt-6">
                <p className="mb-4 text-xs">
                  ...
                  are and will remain the exclusive property of Nullbox Ltd and its licensors. The Service is protected
                  by copyright, trademark, and other laws of both the United Kingdom and foreign countries.
                </p>
                <p className="mb-4 text-xs">
                  Our trademarks and trade dress may not be used in connection with any product or service without the
                  prior written consent of Nullbox Ltd.
                </p>
              </CardContent>
            </Card>
          </section>
          ...
          <section>
            ...
            <Card>
              <CardContent className="pt-6">
                <p className="mb-4 text-xs">
                  You may use the Service only for lawful purposes and in accordance with the Terms. You agree not to
                  use the Service:
                </p>
                <ul className="list-disc pl-6 space-y-2 mb-4 text-xs">
                  ...
                  <li>
                    ...
                    or which, as determined by us, may harm or offend the Company or users of the Service or expose them
                    to liability.
                  </li>
                </ul>
          ...
          <section>
            ...
            <Card>
              <CardContent className="pt-6">
                <p className="mb-4 text-xs">
                  These services are provided by the Company on an "as is" and "as available" basis. The Company makes
                ...
                <p className="mb-4 text-xs">
                  To the fullest extent permitted by applicable law, the Company expressly disclaims all warranties,
                  express or implied, including but not limited to implied warranties of merchantability and fitness for
                  a particular purpose. The Company will not be liable for any damages of any kind arising from the use
                  of this service, including, but not limited to direct, indirect, incidental, punitive, and
          ...
          <section>
            ...
            <Card>
              <CardContent className="pt-6">
                <p className="mb-4 text-xs">
                  To the maximum extent permitted by applicable law, in no event shall the Company, its directors,
          ...
          <section>
            ...
            <Card>
              <CardContent className="pt-6">
                <p className="mb-4 text-xs">
                  You agree to defend, indemnify, and hold harmless the Company, its licensors and service providers,
                  and its and their respective officers, directors, employees, contractors, agents, licensors,
                  ...
                  relating to your violation of these Terms of Service or your use of the Service, including, but not
                  limited to, your User Contributions, any use of the Service's content, services, and products other
                  than as expressly authorized in these Terms of Service, or your use of any information obtained from
                  the Service.
                </p>
              </CardContent>
            </Card>
          ...
          <section>
            ...
            <Card>
              <CardContent className="pt-6">
                <p className="mb-4 text-xs">If you have any questions about these Terms, please contact us:</p>
                <ul className="list-disc pl-6 space-y-2 text-xs">
                  <li>
                    By email:{" "}
