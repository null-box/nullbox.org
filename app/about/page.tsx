...
import { Star, BookOpen, Github, RefreshCw, Minimize2, Users } from "lucide-react"

export const metadata = {
  title: "About Us",
  description: "Learn about Nullbox Ltd and our mission to engineer clarity from complexity.",
}
  ...
  return (
    <div className="p-4 md:p-6">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-lg font-medium mb-4">About Nullbox</h1>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8 items-center">
          <div>
            ...
            <p className="text-xs text-muted-foreground mb-3">
              Our approach combines deep technical expertise with a focus on knowledge transfer, ensuring our clients
              not only receive exceptional solutions but also gain the skills to evolve and maintain them.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card-minimal-zoom-only group transition-transform duration-300 hover:scale-105">
              <div className="pt-4 px-4">
                ...
                <p className="text-xs">
                  We believe in doing things right. Our solutions are built with quality, security, and maintainability
                  as core principles.
                </p>
              </div>
            </div>
            ...
            <div className="card-minimal-zoom-only group transition-transform duration-300 hover:scale-105">
              <div className="pt-4 px-4">
                ...
                <p className="text-xs">
                  We're committed to empowering our clients through education, documentation, and hands-on training.
                </p>
              </div>
            </div>
            ...
            <div className="card-minimal-zoom-only group transition-transform duration-300 hover:scale-105">
              <div className="pt-4 px-4">
                ...
                <p className="text-xs">
                  We actively contribute to and advocate for open source software, believing it drives innovation and
                  quality.
                </p>
              </div>
            </div>
            ...
            <div className="card-minimal-zoom-only group transition-transform duration-300 hover:scale-105">
              <div className="pt-4 px-4">
                ...
                <p className="text-xs">
                  Technology evolves rapidly. We stay at the forefront through constant learning and experimentation.
                </p>
              </div>
            </div>
            ...
            <div className="card-minimal-zoom-only group transition-transform duration-300 hover:scale-105">
              <div className="pt-4 px-4">
                ...
                <p className="text-xs">
                  We value elegant, simple solutions over complex ones. Complexity should only be introduced when
                  necessary.
                </p>
              </div>
            </div>
            ...
            <div className="card-minimal-zoom-only group transition-transform duration-300 hover:scale-105">
              <div className="pt-4 px-4">
                ...
                <p className="text-xs">
                  We see our clients as partners. Your success is our success, and we're invested in your long-term
                  outcomes.
                </p>
              </div>
            </div>
