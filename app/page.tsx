    ...
    <div className="flex flex-col">
      ...
      <section className="container mx-auto px-4 py-8 border-t border-border/10">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-base font-medium mb-3 text-center">About Nullbox</h2>
          <p className="text-xs text-muted-foreground mb-4 text-center">
            Nullbox Ltd is a premium consultancy specializing in cloud architecture, platform engineering, and technical
