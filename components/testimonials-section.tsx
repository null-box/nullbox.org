    ...
    <section className="container mx-auto px-4 py-8 border-t border-border/10">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 max-w-4xl mx-auto">
        <Card className="card-minimal">
          <CardContent className="p-4">
            <p className="text-xs text-muted-foreground mb-3 italic">
              "Nullbox transformed our cloud infrastructure, reducing costs by 40% while improving reliability. Their
              expertise in AWS and Terraform was invaluable."
            </p>
        ...
        <Card className="card-minimal">
          <CardContent className="p-4">
            <p className="text-xs text-muted-foreground mb-3 italic">
              "The technical training provided by Nullbox elevated our entire engineering team. Their hands-on approach
              to teaching Kubernetes and CI/CD practices was exactly what we needed."
            </p>
            <div className="flex justify-end">
        ...
        <Card className="card-minimal">
          <CardContent className="p-4">
            <p className="text-xs text-muted-foreground mb-3 italic">
              "Working with Nullbox on our platform engineering initiative was a game-changer. They didn't just build a
              solution; they transferred knowledge to our team throughout the process."
            </p>
            <div className="flex justify-end">
